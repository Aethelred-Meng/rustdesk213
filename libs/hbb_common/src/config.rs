...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("GoToDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["hb.server.9az.ren"];
pub const PUBLIC_RS_PUB_KEY: &str = "888999000";
